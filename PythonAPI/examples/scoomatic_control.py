...
"""
Welcome to CARLA scoomatic control.
...
class KeyboardControl(object):
    ...
    def _parse_scoomatic_keys(self, keys, milliseconds):	
        if keys[K_LEFT] or keys[K_a]:
            self._control.left_velocity = 3
        else:
            self._control.left_velocity = 0
        if keys[K_RIGHT] or keys[K_d]:
            self._control.right_velocity = 3
        else:
...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        self._info_text = [
            ...
            '']
        if isinstance(c, carla.ScoomaticControl):
            self._info_text += [
            ('Left Velocity:', c.left_velocity, 0.0, 10.0),
            ('Right Velocity:', c.right_velocity, 0.0, 10.0)]
            self._info_text += [
                '',
                'Collision:',
                collision,
